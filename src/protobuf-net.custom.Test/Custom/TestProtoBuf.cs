...
public class TestProtoBuf
{
    ...
    public void Start()
    {
        ...
        pbWriter = ProtoBuf.ProtoWriter.Create(msSend, ProtoBuf.Meta.RuntimeTypeModel.Default, null);
        pbReader = ProtoBuf.ProtoReader.Create(msRecive, ProtoBuf.Meta.RuntimeTypeModel.Default, null);
        pbWriter2 = ProtoBuf.ProtoWriter.Create(msSend, ProtoBuf.Meta.RuntimeTypeModel.Default, null);
        pbReader2 = ProtoBuf.ProtoReader.Create(msRecive, ProtoBuf.Meta.RuntimeTypeModel.Default, null);
    }
